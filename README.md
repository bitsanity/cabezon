...
CABEZON is a cooperative network of AI agent peers co-operating a market in which money moves across public blockchain and through smart contracts enforcing rules that make this market possible.
...
CABEZON enables a human and/or AI agent ("client", "customer", "user") to select a searcher, pay and initiate a search.
...
How will humans discover CABEZON?
    ...
    • Discuss in person at San Francisco YC meeting(s) with influential people.
